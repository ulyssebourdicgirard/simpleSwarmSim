...
def generate_gif_from_log(log_path):
    ...
    Reads the trajectory.npz file generated by the Logger and creates a GIF using all available CPU threads.
    """
    import config
    ...
    print(f"[Visu] Generating frames on {num_cores} CPU threads...")
